    ...
    <div class="container">
        ...
        <div class="d-flex align-items-center">
            <span class="navbar-text text-white me-3">
                👋 Xin chào, <strong><c:out value="${sessionScope.user.userName}" default="Admin" /></strong>
            </span>
...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="${pageContext.request.contextPath}/admin/addCategory" class="btn btn-success btn-sm shadow-sm">+ Thêm Category</a>
    </div>
